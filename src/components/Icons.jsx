...
export const Icons = {
  ...
  logo: (props) => (
    ...
    >
      <path
        fillRule="evenodd"
        d="m17.954 38.095.519-.38h4.871l1.038 1.051v5.192l-.779.788h-1.931l-3.718-3.734v-2.917zm.364-6.413h4.928l1.166 1.191v2.791l-1.061.626h-4.679l-1.623-1.924V33.19l1.269-1.508zm-2.295-5.643 1.278-.604h6.027l1.083 1.117v3.229l-1.185.706h-5.34l-1.863-1.922v-2.526zM18.314 50h13.37c2.316-2.315 4.376-4.854 6.689-7.167.57-2.711.915-5.207.21-7.937 1.043-2.334 1.191-4.973.925-7.486l5.753-8.315c.895-9.71.749-15.202-10.874-16.483L29.863 0h-9.728l-4.523 2.612C3.982 3.894 3.849 9.386 4.737 19.095l5.754 8.316c-.266 2.517-.119 5.149.924 7.487-.705 2.735-.358 5.221.209 7.936 2.316 2.31 4.375 4.851 6.69 7.166zm8.341-12.284h4.871l.519.38v2.916l-3.718 3.734h-1.931l-.779-.788v-5.192l1.038-1.05zm.098-6.034h4.928l1.269 1.508v1.177l-1.623 1.924h-4.679l-1.061-.626v-2.791l1.166-1.192zm-.082-6.247h6.026l1.279.604v2.525l-1.863 1.922h-5.34l-1.185-.706v-3.229l1.083-1.116z"
        clipRule="evenodd"
      />
    </svg>
  ),
